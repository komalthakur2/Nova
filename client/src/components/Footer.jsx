  ...
  return (
   <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
        ...
        <div className="md:max-w-96">
           <img className="h-9" src={assets.logo} alt="logo"/>
            <p className="mt-6 text-sm">
               Experience the power of AI with Nova - your ultimate content creation companion. From blog posts to social media updates, Nova helps you craft compelling content effortlessly.
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © <a href="https://nova.com">Nova</a>. All Right Reserved.
    </p>
</footer>
  )
}
